...
var _HTMLDocument = _interopRequireDefault(require("./HTMLDocument"));
...
app.get('*', function (req, res) {
  ...
  var appRenderedToString = _server.default.renderToString(sheet.collectStyles(_react.default.createElement(_reactRedux.Provider, {
    store: store
  ...
  var stylesRenderedToCSS = sheet.getStyleTags();
  ...
  if (context.url) {
    ...
    res.write(new _HTMLDocument.default({
      head: {
